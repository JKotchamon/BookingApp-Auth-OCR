...
if(isset($_POST['submit']))
  {
    ...
    $ret = "SELECT ID, Password FROM tbluser WHERE Email = :email LIMIT 1";
    ...
    if (!$existingUser) {
        ...
        if (empty($existingUser->Password)) {
            $_SESSION['merge_email'] = $email;
            $_SESSION['merge_fname'] = $fname;
            $_SESSION['merge_mobno'] = $mobno;
            echo "<script>window.location.href='signup-merge-prompt.php';</script>";
        } else {
